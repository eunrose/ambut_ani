              ...
              itemBuilder: (context, index) {
                ...
                return StickyHeader(
                  ...
                  header: index >= 1
                    ...
                    child: Text(
                      date,
                      style: const TextStyle(color: AppColors.greyColor, fontWeight: FontWeight.w500),
                    ),
                  )
                      : Container()
                      : Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 15, color: _items[index]['isCashIn'] ? AppColors.redColor : AppColors.redColor),
                                ),
                                // Text(
                                //   date,
